...
def upgrade():
    ...
    op.create_table('bim_total_table',
    sa.Column('bim_total_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('total_bim', sa.Float(), nullable=True),
    sa.PrimaryKeyConstraint('bim_total_id')
    )
